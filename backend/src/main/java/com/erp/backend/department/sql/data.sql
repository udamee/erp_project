...
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_LOG', 'ROLE_STAFF', '관리약사', 'EX_LOG_STOCK_ADJUST',
        '물류관리부 사원 중 관리약사에게 재고 조정 권한 부여');

-- 물류부서 (DEPT_LOG)
-- [매니저] 재고 조정 권한
INSERT INTO DEPT_ROLE_EXCEPTION (EXCEPTION_ID, DEPT_CODE, ROLE_CODE, EXCEPTION_TITLE, EXCEPTION_AUTH, DESCRIPTION)
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_LOG', 'ROLE_MANAGER', '재고 조정관', 'EX_LOG_STOCK_ADJUST', '물류부 매니저 중 실물 재고 오차 수정 및 조정 권한');

-- [직원] 관리약사 권한 (의약품/위험물 취급 부서 특수 직함)
INSERT INTO DEPT_ROLE_EXCEPTION (EXCEPTION_ID, DEPT_CODE, ROLE_CODE, EXCEPTION_TITLE, EXCEPTION_AUTH, DESCRIPTION)
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_LOG', 'ROLE_STAFF', '관리약사', 'EX_LOG_MED_MANAGE', '물류부 직원 중 전문 의약품 반출 승인 권한');

-- 재무/회계부서 (DEPT_FIN)
-- [매니저] 자금 집행 고액 승인 권한
INSERT INTO DEPT_ROLE_EXCEPTION (EXCEPTION_ID, DEPT_CODE, ROLE_CODE, EXCEPTION_TITLE, EXCEPTION_AUTH, DESCRIPTION)
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_FIN', 'ROLE_MANAGER', '고액 결재권자', 'EX_FIN_HIGH_AMOUNT', '재무부 매니저 중 5천만 원 이상 지출 승인 권한');

-- [직원] 감사 보조 권한 (시즌 한정 또는 특정 직원 부여)
INSERT INTO DEPT_ROLE_EXCEPTION (EXCEPTION_ID, DEPT_CODE, ROLE_CODE, EXCEPTION_TITLE, EXCEPTION_AUTH, DESCRIPTION)
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_FIN', 'ROLE_STAFF', '내부 감사원', 'EX_FIN_AUDIT_ASSIST', '재무부 직원 중 회계 장부 마감 검증 및 감사 로그 열람 권한');

-- 인사/총무부서 (DEPT_HR)
-- [매니저] 채용/평가 정보 열람 권한
INSERT INTO DEPT_ROLE_EXCEPTION (EXCEPTION_ID, DEPT_CODE, ROLE_CODE, EXCEPTION_TITLE, EXCEPTION_AUTH, DESCRIPTION)
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_HR', 'ROLE_MANAGER', '인사평가 위원', 'EX_HR_EVAL_VIEW', '인사부 매니저 중 임직원 고과 성과 지표 열람 및 수정 권한');

-- [직원] 개인정보 마스킹 해제 권한
INSERT INTO DEPT_ROLE_EXCEPTION (EXCEPTION_ID, DEPT_CODE, ROLE_CODE, EXCEPTION_TITLE, EXCEPTION_AUTH, DESCRIPTION)
VALUES (DEPT_ROLE_EXCEPTION_SEQ.NEXTVAL, 'DEPT_HR', 'ROLE_STAFF', '개인정보 취급자', 'EX_HR_PRIVACY_UNMASK', '인사부 직원 중 증명서 발급 등을 위한 주민번호 마스킹 해제 권한');
